...
import org.probato.test.suite.UC14_SuiteWithInvalidProcedure;
import org.probato.test.suite.UC15_SuiteWithInvalidProcedureMethod;
import org.probato.test.suite.UC12_SuiteWithIgnoredScript;
import org.probato.test.suite.UC13_SuiteWithIgnoredProcedure;

@DisplayName("UT - ProcedureComponentValidator")
class ProcedureComponentValidatorTest {
	...
	private static Stream<Arguments> getInvalidProcedureClassData() {
		return Stream.of(
				...
				Arguments.of(
						UC14_SuiteWithInvalidProcedure.class,
				...
				Arguments.of(
						UC15_SuiteWithInvalidProcedureMethod.class,
