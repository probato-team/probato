...
import org.probato.test.script.UC07TC01_ScriptDescriptionMaxLength;

@Suite(code = "UC07", name = "Suite 07", description = UC07_SuiteDescriptionMaxLenght.DESCRIPTION)
public class UC07_SuiteDescriptionMaxLenght {
