...
/**
 * Selenium-based Edge browser session.
 */
final class SeleniumEdgeSession implements NativeBrowserSession<WebDriver> {

	private final BrowserSessionData data;

	private WebDriver driver;

	public SeleniumEdgeSession(BrowserSessionData data) {
		this.data = data;
	}
