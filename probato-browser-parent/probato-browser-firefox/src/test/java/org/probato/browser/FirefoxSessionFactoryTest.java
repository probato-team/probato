...
@DisplayName("UT - Firefox session factory")
class FirefoxSessionFactoryTest {
	...
	void shouldCreatePlaywrightSessionWhenEngineIsPlaywright() {
		...
		var session = FirefoxSessionFactory.create(data);
	...
	void shouldCreateSeleniumSessionWhenEngineIsSelenium() {
		...
		assertNotNull(session);
		assertTrue(session instanceof SeleniumFirefoxSession,
				"Expected SeleniumFirefoxSession when execution.engine=selenium");
	}
	...
	void shouldCreateSeleniumSessionWhenEngineIsNotDefined() {
		...
		assertNotNull(session);
		assertTrue(session instanceof SeleniumFirefoxSession,
				"Expected SeleniumFirefoxSession when execution.engine is not defined");
	}
	...
	void shouldFailWhenEngineIsInvalid() {
		...
		var exception = assertThrows(IntegrityException.class, () -> FirefoxSessionFactory.create(data));
