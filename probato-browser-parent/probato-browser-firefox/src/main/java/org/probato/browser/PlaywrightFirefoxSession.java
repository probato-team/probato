...
/**
 * Playwright-based Firefox browser session.
 */
final class PlaywrightFirefoxSession implements NativeBrowserSession<Page> {
	...
	public PlaywrightFirefoxSession(BrowserSessionData data) {
		this.data = data;
	}
	...
	private void setup() {
		...
		browserInstance = playwright.firefox()
